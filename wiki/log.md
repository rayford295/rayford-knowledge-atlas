...
- Archived the CaGIS 2026 extended abstract as `publications/2026-rapidmap-cagis-multi-agent-disaster-mapping.pdf` (10 pages) and registered it in the publication archive table and `raw/publications/publications.json`.
